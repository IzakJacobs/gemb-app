    ...
    <div class="login-wrap">
      <div class="login-card">
        ...
        <div class="alert alert-info" style="font-size:.88rem;">
          ...
          A <strong>6-digit OTP</strong> has been sent to your WhatsApp number
          ending in <strong><?= htmlspecialchars(substr(preg_replace('/\D/', '', $_SESSION['pending_phone'] ?? ''), -3)) ?></strong>.<br>
